    ...
    <>
            ...
            <Link legacyBehavior href="/neotkrivaetsadverca">
              <a className="frame1196-container121">
                <p className="frame1196-text120">
                  У стиральной машины не откр��вается дверца
                </p>
        ...
        <section className="frame1196-container123">
          <p className="frame1196-text122">
            ...
            <span className="frame1196-text128">
              Профессионально устраняем люб��е неиспр����ности стиральных ��ашин —
            ...
            <div className="frame1196-container125">
              <div className="frame1196-container126">
                ...
                <p className="frame1196-text134">
                  <span>Бесплатный выезд специалиста в любой район гор��да</span>
                </p>
              </div>
              <img
                alt='""'
            ...
            <div className="frame1196-container129">
              <div className="frame1196-container130">
                ...
                <p className="frame1196-text138">
                  <span>Не нужно ждать несколько дней — ваша техника заработает уже ��егодня.</span>
                </p>
              </div>
              <img
                alt='""'
          ...
          <section className="frame1196-container132">
            <div className="frame1196-blue1">
              ...
              <div className="frame1196-container135">
                <span className="frame1196-text145">��есплатно</span>
                <svg
                  width="100%"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"
            ...
            <div className="frame1196-blue2">
              ...
              <div className="frame1196-container139">
                <span className="frame1196-text149">Бесплатн��</span>
                <svg
                  width="100%"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"
              ...
              text={
                <Fragment>
                  <span className="frame1196-text175">
                    <span>Устранение постороннего пред��ета из барабана, фильтра ��ли на��оса</span>
                  </span>
                </Fragment>
              }
              text1={
              ...
              text={
                <Fragment>
                  <span className="frame1196-text195">
                    <span>Замена амортизаторов (без учетаа ��тоимост�� амортизаторо��)</span>
                  </span>
                </Fragment>
              }
              text1={
        ...
        <section className="frame1196-remont-vsehmar">
          ...
          <div className="frame1196-container151 carousel">
            <div className="frame1196-container152 track">
              <div className="item">
                <Image
                  alt="Ремонт стиральных машин Ariston в Одессе - профессиональн��й сервис"
              ...
              <div className="item">
                <Image
                  alt="Ре��онт стиральных машин Beko в О����ссе - профессиональный сервис"
              ...
              <div className="item">
                <Image
                  alt="Ре��онт с��иральных м��шин Gorenje в Одессе - профессиональный сервис"
              ...
              <div className="item">
                <Image
                  alt="Ремонт стиральных машин Atlant в Оде��се - профессиональный ��ервис"
                ...
                <div className="frame1196-container169">
                  <div className="frame1196-container170">
                    <h3 className="frame1196-text220">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: 'Налаженные ��вязи с поставщиками',
                        }}
                      ></span>
                    </h3>
                    <svg
                ...
                <div className="frame1196-container173">
                  <div className="frame1196-container174">
                    <h3 className="frame1196-text222">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: 'Низ��ие ��ены на весь сервисный диапазон услуг',
                        }}
                      ></span>
                    </h3>
                    <svg
            ...
            <div className="frame1196-container175">
              ...
              <div className="frame1196-container176">
                ...
                <p className="frame1196-text225">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Квалифициров��нные специ��листы, которые знают своё де��о.',
                    }}
                  ></span>
                </p>
              </div>
            ...
            <div className="frame1196-container185">
              <div className="frame1196-container186">
                <figcaption className="frame1196-text229">
                  Установка нового уплотнителя дверцы с��иралки Zanussi
                </figcaption>
              </div>
            </div>
            <div className="frame1196-container187">
              <div className="frame1196-container188">
                <figcaption className="frame1196-text230">
                  Вышел из с��роя нагревательный элемент на Bosch
                </figcaption>
              </div>
            </div>
            <div className="frame1196-container189">
              <div className="frame1196-container190">
                <figcaption className="frame1196-text231">
                  Замена кр��стовины барабана на Miele
                </figcaption>
              </div>
            </div>
            ...
            <div className="frame1196-container195">
              <div className="frame1196-container196">
                <figcaption className="frame1196-text234">
                  Ремонт подшипн��ков на стиралке Samsung
                </figcaption>
              </div>
            </div>
            <div className="frame1196-container197">
              <div className="frame1196-container198">
                <figcaption className="frame1196-text235">
                  Установка ТЭНа и Демпферов в маш��не Whirlpool
                </figcaption>
              </div>
            </div>
            <div className="frame1196-container199">
              <div className="frame1196-container200">
                <figcaption className="frame1196-text236">
                  ��осстановление упп��авляющей платы на Siemens
                </figcaption>
              </div>
            </div>
        ...
        <div className="frame1196-container206">
          <div className="frame1196-container207">
            <h2 className="frame1196-text238">
              <span>Ответы на часто за��аваемые вопросы!</span>
            </h2>
          </div>
          <svg
            width="410"
          ...
          <div className="frame1196-container212">
            <div className="frame1196-container213">
              ...
              >
                <span
                  dangerouslySetInnerHTML={{
                    __html: '��аку�� гарантиюю вы п��ед��ставляете?',
                  }}
                ></span>
              </h3>
            </div>
          ...
          <div className="frame1196-container215">
            ...
            <div className={`frame1196-otvet3 ${activeFAQ === 3 ? 'faq-active' : ''}`}>
                <p className="frame1196-text244">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Диаг����стика стоит 200 г��ивен. При согласии на р��монт стоимость диагоностики засчитывается в общую сумму работ. Выезд мастера бесплатный',
                    }}
                  ></span>
                </p>
            </div>
          ...
          <div className="frame1196-container221">
            <div className="frame1196-container222">
              ...
              >
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Де��евле отремонтиро��ать или заменить?',
                  }}
                ></span>
              </h3>
            </div>
          ...
          <ul className="frame1196-ul1 list">
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Работаем напрямую с постав����иками — без переплат и посредников.',
                  }}
                ></span>
              </span>
            </li>
          ...
          <ul className="frame1196-ul2 list">
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Машина н�� сливает воду — проблема с помпой или засор сливн��й системы.',
                  }}
                ></span>
              </span>
            </li>
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Не греет воду — диагно��тика и зам��на ТЭНа.',
                  }}
                ></span>
              </span>
            </li>
        ...
        <div className="frame1196-container228">
          <article className="frame1196-frame10721">
            ...
            <p className="frame1196-text276">
              Я долбоеб. я не могу жить без стиралки, пото��у что когда она сломана я не могу плакать на взрыд во время отжима.
            </p>
            <svg
              width="330"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <style jsx>
        {`
          ...
          .frame1196-text133, .frame1196-text135, .frame1196-text137 { font-weight: 400; }
          .frame1196-icon148 {
            height: 5px;
            max-width: 100px;
          }
          ...
          /* Hover э���фекты для навигаци�� в футере */
          ...
          /* У���ираем margin-bottom �� ���лока с з��голо��ком и кнопкой ��о 1618px */
